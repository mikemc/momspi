...
all_together_pruned_fc_changes <- do.call(rbind, pruned_fc_changes)
saveRDS(all_together_pruned_fc_changes, "~/GitHub_Repos/MOMSPI/momspi/data/FC_data/FC_changes_all_pruned.RDS")
...
all_together_nonprune_all <- do.call(rbind, nonpruned_fc_changes)
saveRDS(all_together_nonprune_all, "~/GitHub_Repos/MOMSPI/momspi/data/FC_data/FC_changes_all_nonprune.RDS")
